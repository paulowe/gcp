...
10. Why is failover behavior not considered as High availability for Relational DBs (whereas Spanner and NoSql offerings are considered HA). What are stand-by instances for in Cloud SQL?
