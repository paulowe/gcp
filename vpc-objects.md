...
- One subnet per region is automatically created within it
...
- All the subnets fit in the 10.128.0.0/9 CIDR block (2^11 unique subnets, or "regions" can exist and be supported by one network)
